    ...
    return (
        <div className="min-h-screen bg-[#0B0F17] text-white flex flex-col font-display overflow-x-hidden">
            ...
            <main className="flex-1 pt-32">
                ...
                {/* ── Hero Visual ── */}
                <section className="py-20 px-6 lg:px-12 border-y border-white/5">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center max-w-2xl mx-auto mb-12">
                            ...
                            <p className="text-lg text-slate-400 font-medium">
                                Painel em tempo real com frota, finanças e desempenho operacional em um só lugar.
                            </p>
                        </div>

                        <div className="relative">
                            <div className="absolute -inset-4 bg-gradient-to-r from-primary-500/10 via-cyan-500/5 to-blue-500/10 rounded-[3rem] blur-3xl pointer-events-none" />
                            <img
                                src="/images/hero-dashboard.png"
                                alt="SistemLog — Painel de Controle"
